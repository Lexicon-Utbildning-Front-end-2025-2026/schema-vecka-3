# 📅 Schema vecka 3
Övergripande schema över andra veckan i TypeScript

##### TypeScript, vecka 2 av 3 (fördjupning med object, funktioner & DOM)
...
* [Projekt Fortsättning](https://github.com/linuszocom/TypeScript-Mini-Projekt-Fortsattning/tree/main)
...
* [TypeScript Boilerplate](https://github.com/Lexicon-frontend-2025/ts-boilerplate)
  (Ändra gärna "module" och "target" i tsconfig.json till "es2002")
